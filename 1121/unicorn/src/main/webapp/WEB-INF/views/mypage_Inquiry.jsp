            ...
            <div class="board_list_item">
              ...
              <div class="board_list_table">
                <table>
                  ...
                  <tr>
                    <td class="board_top"><input class="allcheck" name="checked" type="checkbox"></td>
					...
					<c:if test="${empty inquiry }">
             		...
             		<c:forEach var="dto" items="${inquiry}" varStatus="status">
                  <tr>
                    <td><input class="check" name="list_remove" value="${dto.inquiryno }" type="checkbox"></td>
                    <td class="board_num"> ${status.count }</td>
