...
public class CouponServiceImpl implements CouponService {
	...
	public List validCoupon() {
		...
		List list = couponDAO.validCoupon();
		System.out.println("couponService validcoupon: " + list);
	...
	public int countCoupon(CouponDTO dto) {
		...
		int result = couponDAO.countCoupon(dto);
		System.out.println("countCoupon service : " + result);
