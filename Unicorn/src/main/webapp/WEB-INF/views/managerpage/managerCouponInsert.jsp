...
<head>
<meta charset="UTF-8">
<title>manager_coupon_insert</title>
<style>
...
<!-- 						<li class="menubar_item"><a href="">쿠폰 지급</a></li> -->
				...
				<div class="orderbar">
					<div class="orderbar_title">쿠폰 추가</div>

					<form action="managerCouponDoInsert" method="post">
						<div class="orderbar_item">

							<table>
								<tr>
									<td class="table_top">쿠폰명</td>
									<td class="table_data"><input class="eventInputName"
										type="text" name="serialno"></td>
								</tr>
								<tr>
									<td class="table_top">쿠폰 가격</td>
									<td class="table_data"><input class="eventInputName"
										type="text" name="coupondc"></td>
								</tr>
								<tr>
									<td class="table_top">쿠폰 시작일</td>
									<td class="table_data"><input class="eventInputName"
										type="date" name="startdate"></td>
								</tr>
								<tr>
									<td class="table_top">쿠폰 만료일</td>
									<td class="table_data"><input class="eventInputName"
										type="date" name="validdate"></td>
								</tr>
								<tr>
									<td class="table_top">쿠폰 등록 가능여부</td>
									<td class="table_data"><select class="eventInputName"
										name="possible">
