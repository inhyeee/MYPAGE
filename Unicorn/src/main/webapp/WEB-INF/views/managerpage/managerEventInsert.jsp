...
<!-- 						<li class="menubar_item"><a href="">쿠폰 지급</a></li> -->
				...
				<div class="orderbar">
					<div class="orderbar_title">이벤트 글쓰기</div>

					<form action="managerEventDoInsert" method="post">
						<div class="orderbar_item">
							...
							<table>
								<tr>
									...
									<td class="table_data">
									<input class="eventInputName"
										type="file" name="eventTitle"></td>
								</tr>
								<tr>
									<td class="table_top">이벤트 내용</td>
									<td class="table_data">
									<input class="eventInputName"
										type="text" name="eventDetails"></td>
								</tr>
								<tr>
									<td class="table_top">이벤트 시작일</td>
									<td class="table_data">
									<input class="eventInputName"
										type="date" name="eventStart"></td>
								</tr>
								<tr>
									<td class="table_top">이벤트 끝나는일</td>
									<td class="table_data">
									<input class="eventInputName"
										type="date" name="eventEnd"></td>
								</tr>
								<tr>
									<td class="table_top">이벤트 메인 이미지</td>
									<td class="table_data">
									<input class="eventInputName"
										type="file" name="EventMainImg"></td>
								</tr>
