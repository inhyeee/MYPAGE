...
<!-- 						<li class="menubar_item"><a href="">쿠폰 지급</a></li> -->
				...
				<div class="orderbar">
					<div class="orderbar_title">공지사항 글쓰기</div>

					<form action="managernoticeDoInsert" method="post">
						<div class="orderbar_item">
							...
							<table>
								<tr>
									...
									<td class="table_data">
									<input class="noticeName"
										type="text" name="noticeTitle"></td>
								</tr>
								<tr>
									<td class="table_top">공지사항 내용</td>
									<td class="table_data">
									<textarea class="writeNotice"
											name="noticeDetails"></textarea></td>
								</tr>
							</table>
