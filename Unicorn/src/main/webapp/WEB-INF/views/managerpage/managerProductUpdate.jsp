...
<!-- 						<li class="menubar_item"><a href="">쿠폰 지급</a></li> -->
				...
				<div class="orderbar">
					<div class="orderbar_title">제품 수정 | 삭제</div>

					<form action="/unicorn/managerProductDoUpdate" method="post">
						<div class="orderbar_item">
							<table>
								<tr>
									<td class="table_top">제품 번호</td>
									<td class="table_data">${product.productNo}</td>
									<td><input class="tableEdit" type="text" name="productNo"></td>
								</tr>
								<tr>
									<td class="table_top">제품명</td>
									<td class="table_data">${product.productName}</td>
									<td><input class="tableEdit" type="text" name="productName"></td>
								</tr>
								<tr>
									<td class="table_top">제품설명</td>
									<td class="table_data">${product.productEx}</td>
									<td><input class="tableEdit" type="text" name="productEx"></td>
								</tr>
								<tr>
									<td class="table_top">대표이미지1</td>
									<td class="table_data">${product.mainImg1}</td>
									<td><input class="tableEdit" type="text" name="mainImg1"></td>
								</tr>
								<tr>
									<td class="table_top">대표이미지2</td>
									<td class="table_data">${product.mainImg2}</td>
									<td><input class="tableEdit" type="text" name="mainImg2"></td>
								</tr>
								<tr>
									<td class="table_top">대표이미지3</td>
									<td class="table_data">${product.mainImg3}</td>
									<td><input class="tableEdit" type="text" name="mainImg3"></td>
								</tr>
								<tr>
									<td class="table_top">소재</td>
									<td class="table_data">${product.fabric}</td>
									<td><input class="tableEdit" type="text" name="fabric"></td>
								</tr>
								<tr>
									<td class="table_top">제조사</td>
									<td class="table_data">${product.company}</td>
									<td><input class="tableEdit" type="text" name="company"></td>
								</tr>
								<tr>
									<td class="table_top">인기도</td>
									<td class="table_data">${product.popularity}</td>
									<td><input class="tableEdit" type="text" name="popularity"></td>
								</tr>
								<tr>
									<td class="table_top">가격</td>
									<td class="table_data">${product.productPrice}원</td>
									<td><input class="tableEdit" type="text" name="productPrice"></td>
								</tr>
