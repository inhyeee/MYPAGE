		...
		<c:forEach var="dto" items="${data.wishlist }">
			...
			<form action="deleteWishlist" method="post">
				...
				<table class="wishlist_item">
					...
					<tr>
						<td rowspan="3"><img class="wishlist_img"
							src="${dto.mainimg1 }"></td>
					...
					<tr>
						<!-- <td></td> -->
						<td class="wishlist_company">${dto.company }</td>
<!-- 						<td></td> -->
					</tr>
					<tr>
					
						<!-- <td></td> -->
						<td class="wishlist_price">${dto.productprice }</td>
						<td  rowspan="3" class="wishlist_remove">
						<input type="submit" class="remove_btn" value="삭제"></td>
